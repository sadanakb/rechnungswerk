...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'dark:text-stone-200 dark:focus:bg-stone-800 dark:data-[state=open]:bg-stone-800',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-lg border border-stone-200 bg-white p-1 shadow-lg',
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[10rem] overflow-hidden rounded-lg border border-stone-200 bg-white p-1',
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-stone-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      ...
      'focus:bg-stone-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      'dark:text-stone-200 dark:focus:bg-stone-800',
      className
    )}
    checked={checked}
    {...props}
...
const DropdownMenuShortcut = ({
  ...
  <span
    className={cn('ml-auto text-xs tracking-widest text-stone-400 dark:text-stone-500', className)}
    {...props}
  />
)
